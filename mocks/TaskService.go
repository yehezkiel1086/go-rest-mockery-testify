...
func (_m *TaskService) CreateTask(ctx context.Context, task *domain.Task) (*domain.Task, error) {
...
func (_m *TaskService) DeleteTask(ctx context.Context, id uint) error {
...
func (_m *TaskService) GetTaskByID(ctx context.Context, id uint) (*domain.Task, error) {
	ret := _m.Called(ctx, id)
...
func (_m *TaskService) GetTasks(ctx context.Context) ([]domain.Task, error) {
	ret := _m.Called(ctx)
...
func (_m *TaskService) UpdateTask(ctx context.Context, id uint, task *domain.Task) (*domain.Task, error) {
